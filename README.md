...
```
student@student:~/CSC415/ClassroomDemos/SimpleShell$ make run
./Bierman_Robert_HW3_main "Prompt> "
Prompt>  ps
    PID TTY          TIME CMD
   3505 pts/0    00:00:00 bash
   5306 pts/0    00:00:00 make
   5307 pts/0    00:00:00 sh
   5308 pts/0    00:00:00 Bierman_Robert_
   5309 pts/0    00:00:00 ps
Child 5309 finished with status: 0
Prompt>  ls foo
ls: cannot access 'foo': No such file or directory
Child 5310 finished with status: 2
Prompt>  exit
student@student:~/CSC415/ClassroomDemos/SimpleShell$ 
```
